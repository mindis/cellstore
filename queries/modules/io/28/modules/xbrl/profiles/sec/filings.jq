  ...
  return
    {
        ...
        Networks : archives:num-networks($a),
        ReportElements : archives:num-report-elements($a),
        Tables : archives:num-hypercubes($a),
        Axis : archives:num-dimensions($a),
        Members : archives:num-members($a),
