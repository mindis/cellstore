...
angular.module('report-editor')
    .controller('APICtrl', function(_, $log, $scope, $state, $sce, $stateParams, swagger, API_URL, Session, API, PROFILE){
        ...
        /* the queries-api generated by the swagger-js-codegen requires camel case parameters
         instead of dashed parameter names */
        var camelCase = function(id) {
            var tokens = [];
            _.each(id.split(/[.,:#_\/ -]/), function(token, index){
                if(index === 0) {
